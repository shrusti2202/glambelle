...
function Profile() {
  const redirect = useNavigate();
    ...
    const editdata = async (id) => {
        const res = await axios.get(`https://beaidal.com/single_artist.php/${id}`);
        console.log(res.data);
    ...
    const submithandel = async (e) => {
        ...
        if (validation()) {
            ...
            console.log(res);
            if (res.status == 200) {
                setFormvalue({ ...formvalue, name: "", email: "", contact: "", images: "" });
            ...
            <div className="offset-lg-4 col-lg-4 col-md-6 offset-md-3 wow fadeInUp" data-wow-delay="0.1s">
                <div className="team-item bg-light rounded">
                    <div className="text-center border-bottom p-4">
                        <img className="img-fluid rounded-circle mb-4" src={data.images} alt />
                        <h5>{data.name}</h5>
                        <span>Email : {data.email}</span><br /><br />
                        <span>ID : {data.id}</span><br /><br />
                        <span>Mobile : {data.contact}</span><br /><br />
                                                ...
                                                <div className="row g-3">
                                                    <div className="col-md-6">
                                                        <div className="form-floating">
                                                            <input className="form-control" name="name" value={formvalue.name} onChange={getform} id="name" placeholder="Your Name" />
                                                    ...
                                                    <div className="col-md-6">
                                                        <div className="form-floating">
                                                            <input type="number" className="form-control" name="contact" value={formvalue.contact} onChange={getform} placeholder="Your contact" />
                                                            <label htmlFor="number">Your Mobile</label>
                                                        </div>
                                                    </div>
                                                    <div className="col-md-12">
                                                        <div className="form-floating">
                                                            <input type="url" className="form-control" name="images" value={formvalue.images} onChange={getform} id="images" placeholder="Upload Images" />
                                                            <label htmlFor="url">Your Image</label>
                                                        </div>
                                                    </div>

                                                    <div className="col-12">
                                                        <button onClick={submithandel} data-bs-dismiss="modal" className="btn btn-primary w-100  col-3" type="submit">Save</button>
